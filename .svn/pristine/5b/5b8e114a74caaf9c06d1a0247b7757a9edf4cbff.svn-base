...
public class WithdrawMoney extends JPanel implements WindowSize {
	...
	public WithdrawMoney(JFrame frame) {
		this.frame = frame;
		this.setLayout(null);
		this.setBounds(F_0, F_1, F_2, F_3);
		...
		button1 = new RButton("100");
		button1.setBounds(0, 165, 110, 41);
		...
		button2 = new RButton("300");
		button2.setBounds(0, 240, 110, 41);
		...
		button3 = new RButton("500");
		button3.setBounds(0, 315, 110, 41);
		...
		button4 = new RButton("1000");
		button4.setBounds(570, 165, 110, 41);
		...
		button5 = new RButton("1500");
		button5.setBounds(570, 240, 110, 41);
		...
		button6 = new RButton("2000");
		button6.setBounds(570, 315, 110, 41);
		...
		button7 = new RButton("返回");
		button7.setBounds(0, 390, 110, 41);
		...
		button8 = new RButton("确认");
		button8.setBounds(570, 390, 110, 41);
