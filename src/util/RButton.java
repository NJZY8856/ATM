...
//     public static final Color BUTTON_COLOR2 = new Color(91, 118, 173);
    public static final Color BUTTON_COLOR1 = new Color(254, 254, 254);
     public static final Color BUTTON_COLOR2 = new Color(107, 171, 223);
//     public static final Color BUTTON_COLOR1 = new Color(167, 212, 240);
//     public static final Color BUTTON_COLOR2 = new Color(46, 135, 199);
...
//            tran = 0.3F;
        ...
        if (getModel().isPressed()) {
            p1 = new GradientPaint(0, 0, new Color(0, 0, 0), 0, h - 31,
            		new Color(100, 100, 100));
            p2 = new GradientPaint(0, 1, new Color(0, 0, 0, 50), 0, h - 93,
